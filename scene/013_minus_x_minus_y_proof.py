...
class XMinusYProofWhen(Slide):
    def construct(self):
        ...
        self.play(Indicate(equation_3[6:10], color=GREEN), Indicate(equation_3[12:], color=RED))
        ...
        self.play(Indicate(equation_5[1:4], color=GREEN), Indicate(equation_5[6:9], color=RED))
